...
class Backtesting_metrics():
    ...
    def win_rate(self):
        ...
        print("Number of Profitable Trades:", self.profitable_trades)
        print("Number of Loss-Making Trades:", self.lossmaking_trades)
        print("Win Rate:", round(self.win_rate, 2))
    ...
    def avg_pnl_per_trade(self):
        ...
        print("Average Profit per trade:", round(self.avg_profit, 2))
        print("Average Loss per trade:", round(self.avg_loss, 2))

    def ris_reward(self):
        self.avg_pnl_per_trade()
        self.risk_reward = abs(self.avg_profit / self.avg_loss)
        print("Risk Reward Ratio:", round(self.risk_reward, 2))
