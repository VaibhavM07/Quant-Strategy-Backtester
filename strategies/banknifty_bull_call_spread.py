"""
BANKNIFTY Bull Call Spread  — see runners/README.md for parameter docs

Debit spread. Profit if market rises.
Buy ATM CE, sell higher-strike CE.
"""
...
LEGS = [
    {"option_type": "CE", "strike_offset":   0, "side":  1},  # buy  ATM CE
    {"option_type": "CE", "strike_offset": 200, "side": -1},  # sell ATM+200 CE
]
