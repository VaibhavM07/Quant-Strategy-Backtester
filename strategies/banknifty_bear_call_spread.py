"""
BANKNIFTY Bear Call Spread  — see runners/README.md for parameter docs

Credit spread. Profit if market stays flat or falls.
...
LEGS = [
    ...
    {"option_type": "CE", "strike_offset":  200, "side":  1},  # buy  ATM+200 CE
]
